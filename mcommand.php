...
//first write the log
$fd = fopen("/hobby1/vhosts/dichotomize.com/htdocs/log.txt","a+");
fwrite($fd,date("d.m.Y H:i:s A")." -------from $ip---------------" . $info . "\r\n");
fclose($fd);

//now build a response
print "\ndichotomize.com says you are at $ip and at " . date("n/j/Y H:i A") . " and you sent this: \n" . $info . "\n";
